  ...
  const allItems: CommandItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        description: 'See what stands between you and a goal skill',
        icon: Star,
        action: () => go('/ai/skill-gap'),
        category: 'navigate',
      },
      {
        id: 'nav-learning-paths',
        label: 'Learning Paths',
        description: 'Your step-by-step curricula with matched mentors',
        icon: BookOpen,
        action: () => go('/ai/learning-paths'),
        category: 'navigate',
      },
      {
        id: 'nav-group-sessions',
        label: 'Group Sessions',
        description: 'Join or host live workshops',
        icon: Users,
        action: () => go('/group-sessions'),
        category: 'navigate',
      },
      {
        id: 'nav-assessment',
        label: 'Skill Assessment',
        description: 'Take a graded quiz and earn a certificate',
        icon: Hash,
        action: () => go('/ai/assessment'),
        category: 'navigate',
      },
      {
        id: 'nav-messages',
