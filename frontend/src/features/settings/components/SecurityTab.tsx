            ...
            <div className="space-y-4 max-w-md">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="appearance-none bg-background border-border text-foreground placeholder:text-muted-foreground/60 focus:ring-accent/50 focus:border-accent rounded-xl"
                />
              </div>
              <Button 
            ...
            <div className="space-y-4 max-w-md">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="appearance-none bg-background border-border text-foreground placeholder:text-muted-foreground/60 focus:ring-accent/50 focus:border-accent rounded-xl tracking-widest font-mono text-lg"
                />
              ...
              <div className="flex items-center gap-2">
                ...
                <Button 
                  ...
                  className="rounded-xl border-border bg-background hover:bg-muted text-foreground"
                >
                  Cancel
                </Button>
              </div>
            ...
            <form onSubmit={passwordForm.handleSubmit(handlePasswordSave)} className="space-y-6 max-w-md">
              <FormField control={passwordForm.control} name="current" render={({ field }) => (
                <FormItem>
                  ...
                  <div className="relative">
                    <FormControl>
                      <Input {...field} type={showCurrent ? 'text' : 'password'} placeholder="Your current password" className="pr-10 appearance-none bg-background border-border text-foreground placeholder:text-muted-foreground/60 focus:ring-primary/50 focus:border-primary rounded-xl" />
                    </FormControl>
                    <Button
                      variant="ghost"
                      size="icon"
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 h-8 w-8 text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg"
                    >
              ...
              <FormField control={passwordForm.control} name="next" render={({ field }) => (
                <FormItem>
                  ...
                  <div className="relative">
                    <FormControl>
                      <Input {...field} type={showNext ? 'text' : 'password'} placeholder="Min. 8 characters" className="pr-10 appearance-none bg-background border-border text-foreground placeholder:text-muted-foreground/60 focus:ring-primary/50 focus:border-primary rounded-xl" />
                    </FormControl>
                    <Button
                      variant="ghost"
                      size="icon"
              ...
              <FormField control={passwordForm.control} name="confirm" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input {...field} type="password" placeholder="Repeat new password" className="appearance-none bg-background border-border text-foreground placeholder:text-muted-foreground/60 focus:ring-primary/50 focus:border-primary rounded-xl" /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />
